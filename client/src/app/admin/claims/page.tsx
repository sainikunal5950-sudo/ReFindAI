                      ...
                      >
                        ...
                        <td style={{ padding: "16px 20px" }}>
                          <div>
                            ...
                            <p style={{ fontSize: "0.75rem", color: "#92700F", margin: "2px 0 0" }}>
                        ...
                        <td style={{ padding: "16px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                            ...
                            <div>
                              <span style={{ fontSize: "0.82rem", color: "#1A1A1A", fontWeight: 500 }}>
                                {claimant?.name || "Unknown"}
                              </span>
                              <p style={{ fontSize: "0.72rem", color: "#8E8E93", margin: 0 }}>
                                {claimant?.email}
                              </p>
                            </div>
                          </div>
                        ...
                        {/* Verification Details */}
                        <td style={{ padding: "16px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "0.8rem", color: "#6B6B6B" }}>
